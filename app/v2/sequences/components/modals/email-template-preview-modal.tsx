                                ...
                                <CardDescription className="flex flex-col gap-2">
                                    <section className="flex w-full justify-between gap-6 py-2">
                                        <section className="flex grow flex-col gap-2">
                                            <p className="text-xl font-semibold text-gray-600">{ t('outreaches.emailTemplateModal.sequenceStep') }</p>
                                            {loading ? (
                                        ...
                                        <section className="flex grow flex-col gap-2">
                                            <p className="text-xl font-semibold text-gray-600">{t('outreaches.emailTemplateModal.subjectLine')}</p>
                                            {loading ? (
