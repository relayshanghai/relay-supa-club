...
export const Default = ({
    ...
    return (
        <div className="sticky z-[1000] top-0 isolate flex items-center gap-x-6 overflow-hidden rounded-b-md bg-gradient-to-t from-violet-600 via-violet-500 to-violet-400 px-6 py-2.5 text-white shadow-lg">
