const creators = {
    ...
    account: 'Account',
    searchKol: 'Search for an influencer',
    ...
    show: {
        ...
        countries: 'Countries',
        cities: 'Cities',
        similarAudienceKol: 'Influencers with similar audience',
        seeMore: 'See More',
        seeLess: 'See Less',
        similarKols: 'Similar Influencers',
        ...
        statsDescr: {
            ...
            lookAlikes: 'Influencer who write about similar topics',
            genderSplit:
