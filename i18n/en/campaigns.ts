const campaigns = {
    ...
    modal: {
        ...
        addThisInfluencer: 'Add this KOL to your existing campaigns',
        createCampaign: ' or create a new campaign',
        search: 'Search',
        favorites: 'Favorites',
        searchByKeyword: 'Search KOL by name',
        searchDescription: 'You can use a KOLs name to search for your KOL.',
        noResults: 'No results yet. Try searching for a KOL by name. ',
        searchCTA: 'Visit our KOL module for more advanced search ability.',
        addFromFavorites: 'Add a KOL from your resource pool',
        favoritesDescription: 'Here you can add KOLs directly from your resource pool.',
        outreach: 'Outreach',
        details: 'Details',
        content: 'Content',
    ...
    creatorModal: {
        ...
        comments: 'Internal Comments',
        commentsDescr:
            'The comment section can be used to communicate with your team internally about this KOL. This is only seen by your team, and not by the KOL.',
        outboxDescr:
            'The outbox section can be used to track the detail and status of emails sent to the KOL.',
        viewProfile: 'View Profile',
        messagePlaceholder: 'Write here',
        publicationDate: 'Publication Date',
        publicationDescr:
            'This is the date the KOL will post your content. Update this regulary to keep your team and yourself aware of the publication date',
        payment: 'Payment',
        paymentDescr:
            'If you negotiated the price with the KOL, write down the price here to keep track of the rate and the payments you have made.',
        kolRate: 'KOL Rate (in USD)',
        paymentStatus: 'Payment Status',
        paymentInformation: 'Payment Information',
        paidAmount: 'Paid Amount',
        sample: 'Sample',
        sampleDescr:
            'To avoid that samples are sent to the wrong address etc. It is always useful to keep track of the sample status and the address of the KOL.',
        kolAddress: 'KOL Address',
        trackingDetails: 'Tracking Details',
        sampleStatus: 'Sample Status',
        save: 'Save',
        kolUpdated: 'KOL Updated',
        noConnectYet: 'You have not reached out yet to this KOL.',
    ...
    show: {
        ...
        searchForCreator: 'Search for KOL',
        ...
        kolMessages: 'KOL Messages',
        activities: {
            creatorOutreach: 'KOL Outreach',
            campaignInfo: 'Campaign Info',
            campaignTracking: 'Campaign Tracking',
            outreach: {
                addNewCreator: 'Add New KOL',
                all: 'All',
    ...
    form: {
        ...
        requirementsDescription:
            'Additional information for your requirement, to help our algorithm to find you the right KOLs for your campaign',
        ...
        numInfluencerQuestion: 'No. Of KOLs',
        numInfluencerDescription: 'Specify the number of KOLs you would like to reach out to',
        timelineQuestion: 'Campaign Timeline',
        timelineDescription: 'Please specify your campaign launch date',
        outreachEnd: 'KOL Outreach Closing Date',
        campaignLaunch: 'Campaign Launch Date',
        campaignEnd: 'Campaign End Date',
        promotionQuestion: 'Type of Promotion',
        promotionDescription:
            'Please specify the type of promotion you are expecting for this campaign and the KOLs',
