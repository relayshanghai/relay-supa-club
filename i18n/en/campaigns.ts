const campaigns = {
    ...
    creatorModal: {
        ...
        kolRate: 'Influencer Rate (in USD)',
    ...
    show: {
        ...
        noKolYet: 'You do not have any influencers added to your campaign.',
        addKol: 'Click to add influencer',
        comments: 'Comments',
        contact: 'Contact',
        ...
        kolMessages: 'Influencer Messages',
        activities: {
