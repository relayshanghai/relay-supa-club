...
export const chatGuideEn: DriveStep[] = [
    {
...
export const influencerModalGuideAdditionForDiscoveryEn: DriveStep[] = [
    {
...
export const influencerModalGuideAdditionForOutreachEn: DriveStep[] = [
    {
        element: '#boostbot-influencer-table-checkbox',
        popover: {
            title: 'Select creators',
...
export const influencerListMiniReportEn: DriveStep[] = [
    {
...
export const influencerListGuideEn: DriveStep[] = [
    {
...
export const influencerModalGuideEn: DriveStep[] = [
    {
