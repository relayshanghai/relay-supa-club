...
export const crmGuideEn: DriveStep[] = [
    {
        element: '#v2-crm-page',
        popover: {
...
export const templateVariableModalEn: DriveStep[] = [
    {
...
export const templateLibraryModalEn: DriveStep[] = [
    {
...
export const templateLibraryWizardStep1En: DriveStep[] = [
    {
...
export const templateLibraryWizardStep2En: DriveStep[] = [
    {
...
export const campaignWizardStep1En: DriveStep[] = [
    {
...
export const campaignWizardStep2En: DriveStep[] = [
    {
...
export const campaignWizardStep3En: DriveStep[] = [
    {
