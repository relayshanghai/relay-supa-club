...
export const StartSequenceForInfluencer = (trigger: TriggerEvent<StartSequenceForInfluencerPayload>, payload?: StartSequenceForInfluencerPayload) =>
...
StartSequenceForInfluencer.eventName = <typeof OUTREACH_START_SEQUENCE_FOR_INFLUENCER>OUTREACH_START_SEQUENCE_FOR_INFLUENCER;
