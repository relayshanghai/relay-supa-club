...
export const STRIPE_PRICE_MONTHLY_DIY = process.env.STRIPE_PRICE_MONTHLY_DIY || 'price_1MNB61As9LEfZQ298w3oW64k';
export const STRIPE_PRICE_QUARTERLY_DIY = process.env.STRIPE_PRICE_QUARTERLY_DIY || 'price_1MNB5iAs9LEfZQ29sssMyA6m';
export const STRIPE_PRICE_YEARLY_DIY = process.env.STRIPE_PRICE_YEARLY_DIY || 'price_1M8yhpAs9LEfZQ29TSiaQVun';

export const STRIPE_PRODUCT_ID_DIY_MAX = process.env.STRIPE_PRODUCT_ID_DIY_MAX || 'prod_N7PH5AciWQkPyv';
...
export const STRIPE_PRICE_YEARLY_DIY_MAX = process.env.STRIPE_PRICE_YEARLY_DIY_MAX || 'price_1MNBZ8As9LEfZQ29vph62DoE';
