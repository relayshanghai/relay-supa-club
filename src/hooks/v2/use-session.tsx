 ...
 */
export const useSessionV2 = (params?: useSessionParams) => {
...
export const useIdentifySessionV2 = () => {
    const { profile, user, company, subscription } = useSessionV2();

    const identifySession = useCallback(() => {
        if (profile !== null && user !== null && company !== null && subscription) {
            return true;
        }

        return false;
    }, [profile, user, company, subscription]);
