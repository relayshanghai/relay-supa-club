...
import { createSequenceInfluencerCall, updateSequenceInfluencerCall } from 'src/utils/api/db/calls/sequence-influencers';
...
export const useSequenceInfluencers = (sequenceId?: string) => {
    ...
    const createSequenceInfluencer = async (influencerSocialProfileId: string) => {
