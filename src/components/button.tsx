...
const defaultClasses =
    'text-sm px-4 py-2 rounded-md flex-shrink-0 font-bold disabled:bg-gray-300 border-primary-500 border disabled:cursor-default disabled:border-gray-300 disabled:text-gray-500';
