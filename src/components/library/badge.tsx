...
export const Badge = ({
    ...
    return (
        <span
            className={`inline-flex select-none items-center gap-1.5 self-center rounded-md bg-primary-500 py-${py} px-${px} ${fontSize} text-xs font-medium text-white ${className}`}
            {...props}
        >
            {children}
        </span>
