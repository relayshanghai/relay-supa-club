...
const subCategories = [
  { name: 'Trending Influencers', href: '#' },
  { name: 'Food Influencers', href: '#' },
  { name: 'Recently Joined', href: '#' },
  { name: 'LatAm KOLs', href: '#' },
  { name: 'Tiktok Famous', href: '#' },
]
const filters = [
  {
    ...
    options: [
      ...
      { value: 'southkorea', label: 'South Korea', checked: true },
      { value: 'unitedstates', label: 'United States', checked: false },
  ...
  },
  {
    ...
    name: 'Followers',
    options: [
      { value: '2l', label: 'Micro Influencers', checked: false },
      { value: '6l', label: 'Macro Influencers', checked: false },
      { value: '12l', label: 'Giga Influencers', checked: false },
      { value: '18l', label: 'Celebrities', checked: false },
    ],
  },
]
          ...
          <div className="relative z-10 flex items-baseline justify-between pt-6 pb-6 border-b border-gray-200">
            <div className="flex items-center">
              <Menu as="div" className="relative inline-block text-left">
                ...
                >
                  <Menu.Items className="origin-top-right absolute right-0 mt-2 w-40 rounded-md bg-white shadow-2xl ring-1 ring-black ring-opacity-5 focus:outline-none">
                    <div className="py-1">
