...
export const SidebarV2 = ({
    ...
    return (
        ...
        <nav className="z-20 h-full">
            <div className={`pointer-events-none fixed inset-0 opacity-0 transition-all`} onClick={() => null} />
            <div className="inset-y-0 left-0 flex h-full w-20 transform flex-col border-r border-gray-100 bg-white transition-all"></div>
        </nav>
    );
};
