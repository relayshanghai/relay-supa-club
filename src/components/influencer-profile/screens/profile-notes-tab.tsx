...
export const COLLAB_STATUS_OPTIONS: CheckboxDropdownItemData[] = [
    { id: 'Negotiating', label: 'Negotiating', style: 'bg-blue-100 text-blue-500' },
    { id: 'Confirmed', label: 'Confirmed', style: 'bg-blue-100 text-blue-500' },
    { id: 'Shipped', label: 'Shipped', style: 'bg-orange-100 text-orange-500' },
    { id: 'Received', label: 'Received', style: 'bg-fuchsia-100 text-fuchsia-500' },
    { id: 'Content Approval', label: 'Content Approval', style: 'bg-cyan-100 text-cyan-500' },
    { id: 'Posted', label: 'Posted', style: 'bg-primary-100 text-primary-500' },
    { id: 'Completed', label: 'Completed', style: 'bg-green-100 text-green-500' },
    { id: 'Rejected', label: 'Rejected', style: 'bg-red-100 text-red-500' },
];
