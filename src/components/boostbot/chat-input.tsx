    ...
    return (
        <div className="z-10 flex flex-row items-center gap-2 p-4 pt-1 shadow-lg">
            <textarea
                ref={textareaRef}
                rows={1}
                className="flex-grow resize-none rounded-lg border-none px-3 py-4 ring-1 ring-primary-400 hover:ring-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-300"
