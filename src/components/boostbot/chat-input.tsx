    ...
    return (
        <div className="z-10 flex flex-row items-center gap-2 border-t-2  border-slate-100 px-4 py-6 shadow-lg ">
            ...
            <textarea
                ref={textareaRef}
                rows={2}
                className="h-10 flex-grow resize-none rounded-[6px] border-none p-3 text-xs font-medium ring-1 ring-tertiary-200 placeholder:text-gray-400 hover:ring-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-300 2xl:pb-0 2xl:pt-2.5 2xl:text-sm"
