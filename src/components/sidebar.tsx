...
export const Sidebar = ({
    ...
    useEffect(() => {
        const pathsToHideSidebarOn = ['/boostbot'];
        const shouldHideSidebar = pathsToHideSidebarOn.includes(pathname);

        if (desktop && !shouldHideSidebar) setOpen(true);
        else setOpen(false);
    }, [desktop, setOpen, pathname]);
