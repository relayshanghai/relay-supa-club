...
export const config = {
    ...
    matcher: [
         ...
         */
        '/((?!_next/static|_next/image|favicon.ico|assets/*|api/invites/accept*|api/company/create-employee*|login*|login/reset-password|signup/invite*|logout|api/logout|api/subscriptions/webhook|api/webhooks|api/logs/vercel|api/subplan).*)',
    ],
};
