...
export const config = {
    ...
    matcher: [
         ...
         */
        '/((?!_next/static|_next/image|favicon.ico|assets/*|api/invite/accept*|api/company/create-employee*|login*|login/reset-password|signup|signup/invite*|logout|api/logout|error-test).*)',
    ],
};
