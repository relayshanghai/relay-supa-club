                    ...
                    {loading ? null : session && !loading ? (
                        ...
                        <div className="space-x-2">
                            ...
                            <Link href="/login" passHref>
                                <a className="text-sm  px-4 py-2 rounded-md cursor-pointer flex-shrink-0 text-white border border-primary-500 hover:border-primary-700 duration-300 font-bold disabled:bg-gray-300 disabled:cursor-default">
                                    Log in
                                </a>
                            </Link>
                        </div>
                            ...
                            >
                                ...
                                <div className="flex flex-col items-center mb-8">
                                    <ul>
                                        ...
                                        <li className="flex items-center mb-3">
                                            <div className="w-6 h-6 mr-2 text-white"></div>
                            ...
                            >
                                ...
                                <div className="flex flex-col items-center mb-8">
                                    <ul className="text-blueGray-400">
                                        ...
                                        <li className="flex items-center mb-3">
                                            <div className="w-6 h-6 mr-2 text-primary-500"></div>
                                            <span className="text-left">Unlimited Campaigns</span>
                                        </li>
                                        <li className="flex items-center mb-3">
                                            <svg
